...
class PortfolioItem extends React.Component {
    ...
    render() {
        ...
        const MobileContent = styled.div`
            ...
            visibility: visible;
            background-image: linear-gradient(to top, rgba(154, 165, 255, 1), rgba(255, 255, 255, 0));
        ...
        const Item = styled.div`
            ...
            &.blue-shadow {
                box-shadow: 0 28px 60px rgba(154, 165, 255, .2);
                transition: .5s;
                &:hover {
                    box-shadow: 0 28px 60px rgba(154, 165, 255, .5);
                }
